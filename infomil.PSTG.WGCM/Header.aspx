                                ...
                                <div class="user-info align-right dropdown d-inline-block header-dropdown">
                                    <a href="javascript:void(0)" data-toggle="dropdown" class=" menu-style dropdown-toggle">
                                        <div class="user-avatar d-inline-block">
                                            <img src="assets/img/profiles/img-6.jpg" alt="user avatar" class="rounded-circle img-fluid profilePic" style="object-fit: cover; width: 55px; height: 55px;">
                                        </div>
                                    </a>
                    ...
                    <div class="d-block d-lg-none">
                        ...
                        <div class="offcanvas-menu" id="offcanvas_menu">
                            <div class="user-info align-center bg-theme text-center">
                                <a href="javascript:void(0)" class="d-block menu-style text-white">
                                    <div class="user-avatar d-inline-block mr-3">
                                        <img src="assets/img/profiles/img-6.jpg" alt="user avatar" class="profilePic rounded-circle img-fluid" style="object-fit: cover; width: 55px; height: 55px;">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="user-menu-items px-3 m-0">
                                <a class="menuItemMobile px-0 pb-2 pt-0" href="Dashboard.aspx">
                                    <span class="media align-items-center">
                                ...
                                <a class="menuItemMobile p-2 accessManagement" href="Access_Manager.aspx">
                                    <span class="media align-items-center">
                                        ...
                                        <span class="media-body text-truncate text-left">
                                            <span class="text-truncate text-left">Access Manager</span>
                                        </span>
                                    </span>
                                </a>
